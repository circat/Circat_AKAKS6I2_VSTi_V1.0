...
private:
  ...
  // ── FILTER PANEL (contains cutoff, resonance, sweep + type selector) ──────
  std::unique_ptr<UI::FilterPanel> m_filterPanel;
  ...
  std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment>
      ...
      m_lfoDelayAttachment, m_decayAttachment, m_levelAttachment,
      m_tuneAttachment;
