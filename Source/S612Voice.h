...
public:
  ...
  void setFilterType(int type) { m_filterType = static_cast<FilterType>(type); }
  void setFilterResonance(float v) { m_filterResonance = v; }
  void setFilterSweep(float v) { m_filterSweep = v; }
...
private:
  ...
  FilterType m_filterType = FilterType::Moog;
  float m_filterResonance = 0.0f;
  float m_filterSweep = 0.0f;
